...
const HomeScreen: React.FC<HomeScreenProps> = ({ onNavigate }) => {
  ...
  const handleSearchClick = () => {
    ...
    setIsSearching(true);
    setTimeout(() => {
      // Dynamic journey planning: Generate mocked routes specifically for these inputs
      const routes = generateMockRoutes(state.fromLocation, state.toLocation);
      setGeneratedRoutes(routes);
      setIsSearching(false);
      onNavigate('routes');
    }, 800); // Realistic mock delay
  };
      ...
      <div className="bg-white/80 backdrop-blur-md px-5 py-4 pt-10 sticky top-0 z-20 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div>
              <p className="text-neutral-dark font-bold text-sm tracking-tight">{regionConfig.locationContext.currentLocation}</p>
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        ...
        <div className="p-5">
          <Card className="shadow-lg border-none bg-white relative">
            ...
            {/* Swap Button (Absolute positioned to overlap the inputs beautifully) */}
